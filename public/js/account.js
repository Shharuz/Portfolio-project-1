...
/* harmony import */ var _style_account_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../style/account.scss */ "./src/style/account.scss");
...
blockThatHasCounter.forEach(item => {
    ...
    incrementBtn.addEventListener('click', e => __webpack_require__.e(/*! import() | counter-goods */ "counter-goods").then(__webpack_require__.bind(__webpack_require__, /*! ./allScripts/counter-goods.js */ "./src/script/allScripts/counter-goods.js")).then(module => {
    ...
    decrementBtn.addEventListener('click', e => __webpack_require__.e(/*! import() | counter-goods */ "counter-goods").then(__webpack_require__.bind(__webpack_require__, /*! ./allScripts/counter-goods.js */ "./src/script/allScripts/counter-goods.js")).then(module => {
    ...
    inputCount.addEventListener('input', e => __webpack_require__.e(/*! import() | counter-goods */ "counter-goods").then(__webpack_require__.bind(__webpack_require__, /*! ./allScripts/counter-goods.js */ "./src/script/allScripts/counter-goods.js")).then(module => {
...
itemsCategories.forEach(item => {
    item.addEventListener('click', e => Promise.all(/*! import() | workingWithFavoritesContent */[__webpack_require__.e("counter-goods"), __webpack_require__.e("workingWithFavoritesContent")]).then(__webpack_require__.bind(__webpack_require__, /*! ./allScripts/workingWithFavoritesContent.js */ "./src/script/allScripts/workingWithFavoritesContent.js")).then(module => {
