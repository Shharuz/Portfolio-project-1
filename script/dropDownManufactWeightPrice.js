...
function hideFilter(e) {
   ...
   if(e.currentTarget.previousElementSibling.classList.contains('openFilter')){
    ...
    e.currentTarget.previousElementSibling.querySelectorAll('div').forEach( (item) =>{
...
arrowSvgManufactWeight.forEach( (item) =>{
